...
if ($mode == "edit") {;
	...
	$query_CM_Array .= " DATE_FORMAT(issue_date, '%Y') AS issue_year,";
	$query_CM_Array .= " DATE_FORMAT(issue_date, '%m') AS issue_month,";
	$query_CM_Array .= " DATE_FORMAT(issue_date, '%d') AS issue_day";
	$query_CM_Array .= " FROM cm_issues WHERE id = '$id;'";
	...
	$id = $row_CM_Array['id'];
	$issue_day =  $row_CM_Array['issue_day'];
	$issue_month = $row_CM_Array['issue_month'];
	$issue_year = $row_CM_Array['issue_year'];
	$volume = $row_CM_Array['issue_volume'];
	$number = $row_CM_Array['issue_number'];
	$circulation = $row_CM_Array['issue_circulation'];
	$online_only = $row_CM_Array['online_only'];
